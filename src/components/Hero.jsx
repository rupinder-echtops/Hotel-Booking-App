...
const Hero = () => {
    return (
        ...
        <p className='max-w-130 mt-2 text-sm md:text-base'>Unparallered luxury and comfact await at the world's most exclusive hotels and resorts. Start your journey today</p>
