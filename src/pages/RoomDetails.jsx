...
const RoomDetails = () => {
    ...
    return room && (
        <div className="py-8 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32">
        {/* room details */}
        ...
        <div className="flex flex-col lg:flex-row gap-6 mt-6">
            <div className="lg:w-1/2 w-full">
              <img src={mainImage || room.images[0]} alt="room-image" className="w-full rounded-xl shadow-lg object-cover" />  
            </div>
        ...
        <p className="text-2xl font-medium">${room.pricePerNight}/night</p>
            ...
            <form className="flex flex-col md:flex-row items-start md:items-center justify-between bg-white shadow-[0px_0px_20px_rgba(0,0,0,0,15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl">
              ...
              <div className="flex flex-col">
                ...
                <input type="number" id='guest' placeholder="guest" className="max-w-20 rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none" required />
              </div>
              </div>
            ...
            <div className="max-w-3xl border-y border-gray=300 my-15 py-10 text-gray-500">
                <p>Guest will be allocated on the ground floor according to availability. You get a comfortable Two bedroom apartment has a true city feeling. The price quoted id for two guest, at the slot please mark the number of guests to get the exact price for groups. The guests will be allocated ground floor according to availability. You get the comfortable two bedroom apartment that has a true city feeling. </p>
            </div>
            {/*hosted by */}
